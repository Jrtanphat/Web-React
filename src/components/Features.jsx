...
const features = [
  ...
  { icon: RotateCcw, text: "Easy Returns", subtext: "30-day easy returns" },
  { icon: Clock, text: "24/7 Support", subtext: "Dedicated support team" },
];
        ...
        <div className="grid grid-cols-1 gap-y-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-8">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <Icon className="flex-shrink-0 h-10 w-10 text-gray-600" />
                <div className="ml-4">
